...
//	pointcloud.clear();
...
#if USE_SYS_TRIANGULATION
	//Using SYSTEM triangulation
	//convert to Point2f
	...
	triangulatePoints(P,P1,pt_set1_pt_2r,pt_set2_pt_2r,pt_3d_h);

	//calculate reprojection
	vector<Point3f> pt_3d;
	convertPointsHomogeneous(pt_3d_h.reshape(4, 1), pt_3d);
	Mat_<double> R = (Mat_<double>(3,3) << P(0,0),P(0,1),P(0,2), P(1,0),P(1,1),P(1,2), P(2,0),P(2,1),P(2,2));
...
#pragma omp parallel for num_threads(1)
	cout <<"before triangulate: "<< pointcloud.size() << pts_size<<endl;
...
#endif
	cout << "after triangulate: " << pointcloud.size() << endl;
	cout << reproj_error.size() << endl;
